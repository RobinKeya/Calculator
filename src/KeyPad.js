    ...
    render() {
        ...
        return (
            <div className="main">
                ...
                <button className ="button" name="CE" onClick={e => this.props.onClick(e.target.name)}>DEL</button>
                <button className ="button" name=")" onClick={e => this.props.onClick(e.target.name)}>)</button>
                <button className ="button" name="C" onClick={e => this.props.onClick(e.target.name)}>AC</button><br/>
                ...
                <button className ="button" name="+" onClick={e => this.props.onClick(e.target.name)}>+</button><br/>
                ...
                <button className ="button" name="*" onClick={e => this.props.onClick(e.target.name)}>x</button><br/>
